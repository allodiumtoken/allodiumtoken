...
==================================*/    
    ...
    function chart(){
      /* Layout 1 Token Chat */
      var colors = ['#7d7d7d', '#d47c0c', '#f0931e', '#f6e3aa', '#f6aa35', '#fbbd18'];
      var labels = ["10% Presale campaign", "5% Airdrop", "30% Public Sale 1", "30% Public Sale 2", "15% Management", "10 %Development"];
      var data = [10, 5, 30, 30, 15, 10];
      var bgColor = colors;
      var dataChart = {
        labels: labels,
        datasets: [{
      ...
      legendHolder.innerHTML = legend;
       ...
       /* Layout 2 Token Chat */
      var layout2colors = ['#7d7d7d', '#d47c0c', '#f0931e', '#f0931e', '#f6aa35', '#fbbd18'];
      var layout2labels = ["10% Presale", "5% Airdrop", "30% Public Sale 1", "30% Public Sale 1", "10% Development", "15% Management"];
      var layout2data = [10, 5, 30, 30, 10, 15];
